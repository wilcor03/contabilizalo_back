						 	...
						 	@endif
						  	...
						  	<div class="form-group text-center">
							    <button 
							    	...
							    	data-load-url="{{ route('video.by.post', $post)}}"
							    	>
									  Guardar
									</button>
						  	</div>
						 	...
						 	@endif
						  	...
						  	<div class="form-group text-center">
							  	<button 
							    	...
							    	data-load-url="{{ route('file.by.post', $post)}}"
							    	>
									  Subir
									</button>
								</div>
					  ...
					  <div class="well text-center">
						  ...
						  <!-- Button trigger modal -->
							<button 
								...
								data-toggle="modal" 
								data-target="#myModal"
								data-load-url = "{{ route('post.search', $post) }}"
						    ...
						    data-load-url="{{ route('post.recommended.lists', $post) }}"
							></button>
