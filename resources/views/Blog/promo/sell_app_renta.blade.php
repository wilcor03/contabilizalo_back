...
<br>
	<picture class="text-center">
	   {!! Html::image('images/banner-business-tax-2019.png', 'renta personas Jurídicas en Excel', ['width' => '1000px','height' => '220px','class' => 'img-responsive']) !!}
	</picture>

	<hr>

	<h1 class="text-center" style="color:#c1aa03;">Aplicativo Para Elaboración Renta Personas Jurídicas 2019 - Colombia</h1>	
...
 
			...
			<p><strong class="text-primary">BUSINESS TAX</strong>
				cuenta con anexos para las diferentes situaciones.
			</p>

			<ul>
				<li>Depreciación y amortización fiscal</li>
				<li>Diferencia en cambio</li>
				<li>Deterioro de cartera</li>
	      <li>Deterioro o dada de baja de inventarios</li>
	      <li>Compensaciones de pérdidas y excesos de renta presuntiva.</li>
	      <li>Venta de activos fijos (ganancia ocasional y recuperaciones)</li>
	      <li>Subcapitalización</li>
	      <li>Control de aportes de seguridad social y parafiscales</li>
	      <li>Control de impuestos pagados</li>
	      <li>Limitante de gastos del exterior</li>
	      <li>Control de devengos sin factura (Ingresos y costos y gastos)</li>
	      <li>Renta cedular (Para casos especiales)</li>
	      <li>Integra los formatos de la conciliación fiscal Formato 2516.</li>
			</ul>

			<p>Todo lo anterior, teniendo en cuenta los marcos técnicos contables bajo NIIF y la interacción con los impuestos.</p>

			<p>Además calculará automáticamente, anticipo de renta, renta presuntiva, sanciones en el caso de extemporaneidad o corrección, arrojará la conciliación de la utilidad, del patrimonio, justificación patrimonial, calculará la parte gravado o no gravada en cabeza de los accionistas. Etc.</p>
			...
			<p>El aplicativo contará con manuales para cada anexo con el fin del correcto diligenciamiento del mismo.</p>
			...
			<p><strong class="text-primary">BUSINESS TAX</strong>  fue diseñado por el contador  público William Dussán Salazar, especialista en Derecho Tributario, Fundador de www.consultorcontable.com y con experiencia en diseño de herramientas tributarias, cuenta con un diseño intuitivo, un PANEL PRINCIPAL en donde podrá controlar todo el aplicativo mediante botones con hipervínculos y macros para acceder muy fácil a los diferentes anexos y plantillas.</p>

			<p>Además al terminar de elaborar su renta podrá imprimir un resumen de la plantilla sumaria (conciliación fiscal) y de todos los demás anexos que requiera.</p>
			...
			<div class="text text-center">
				<a type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModal">
				  <img class="img-responsive" src="{{ asset('images/boton-compra.png') }}">
				</a>
			</div>
			...
			<div class="panel panel-danger">
			  ...
			  <div class="panel-body">
			    <div class="embed-responsive embed-responsive-16by9">
  					<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DjgWR5-Zddc"></iframe>
					</div>
			    <hr>
			    ...
			    <div class="media">
					  ...
					  <div class="media-body">
					    ...
					    <p>Presentación Aplicativo.pdf <br>
					    	...
					    	<a class="text text-danger" href="{{ url('public_downloads/Presentación Aplicativo.pdf') }}" title="Descarga Gratis Presentación Aplicativo Renta P Jurídicas BUSINESS TAX" target="_blank">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body text-justify">
	      	...
	      	<div class="text text-center">
		        <img src="{{ asset('images/boton-compra.png') }}">
		      </div>
		      ...
		      <div class="panel panel-success">
							  ...
							  <div class="panel-body">
							    <p>
									...
									<hr>
										<div class="text text-center">
											<a href="https://biz.payulatam.com/B07ad09CDA4A1D5"><img src="https://contabilizalo.com/images/btn_comprar_contabilizalo.png"></a>
										</div>
									<hr>
		      ...
		      <div class="media">
					  ...
					  <div class="media-body">
					    <h4 class="media-heading">Condiciones de compra</h4>
					    <p>Condiciones de compra.pdf <br>
					    	Documento Adobe Acrobat 190.9 KB <br>
					    	<a class="text text-danger" href="{{ url('public_downloads/Condiciones de compra.pdf') }}" title="Descarga Gratis Condiciones de uso de licencia BUSINESS TAX" target="_blank">
					    	Descargar <i class="fa fa-cloud-download" aria-hidden="true"></i></a>
